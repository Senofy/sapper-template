export default {
    ...
    weather: {
        fire:
            'https://vignette.wikia.nocookie.net/ffxi/images/2/2c/Trans_Fire.gif',
        ice:
            'https://vignette.wikia.nocookie.net/ffxi/images/c/ca/Trans_Ice.gif',
        wind:
            'https://vignette.wikia.nocookie.net/ffxi/images/e/e6/Trans_Wind.gif',
        earth:
        ...
        dark:
            'https://vignette.wikia.nocookie.net/ffxi/images/d/de/Trans_Dark.gif',
    },
};
